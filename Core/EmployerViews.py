...
def profile(request):
    ...
    return render(request,"Authorized/Employer/Profile_Employer.html", context={'profile': profile, 'form': form, 'jobs': jobs})
...
def edit_profile(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form = EmployerProfileForm(form = EmployerProfileForm(instance=profile))
            return render(request, "Authorized/Employer/edit_employer_profile.html",{'form':form})
