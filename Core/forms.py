...
class ResumeForm(forms.Form):
    ...
    skill_1 = forms.CharField(label='Skill 1', max_length=100, required=True)
    skill_2 = forms.CharField(label='Skill 2', max_length=100, required=True)
    skill_3 = forms.CharField(label='Skill 3', max_length=100, required=True)
    skill_4 = forms.CharField(label='Skill 4', max_length=100, required=True)
    skill_5 = forms.CharField(label='Skill 5', max_length=100, required=True)
    skill_6 = forms.CharField(label='Skill 6', max_length=100, required=True)
    skill_7 = forms.CharField(label='Skill 7', max_length=100, required=True)
    skill_8 = forms.CharField(label='Skill 8', max_length=100, required=True)
    skill_9 = forms.CharField(label='Skill 9', max_length=100, required=True)
    skill_10 = forms.CharField(label='Skill 10', max_length=100, required=True)
